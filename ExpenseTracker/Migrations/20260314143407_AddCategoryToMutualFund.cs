...
{
    /// <inheritdoc />
    public partial class AddCategoryToMutualFund : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FolioNumber = table.Column<string>(type: "text", nullable: true),
                    Units = table.Column<decimal>(type: "numeric(18,4)", precision: 18, scale: 4, nullable: false),
                    Category = table.Column<string>(type: "text", nullable: true),
                    SubCategory = table.Column<string>(type: "text", nullable: true),
                    AvgNAV = table.Column<decimal>(type: "numeric(18,4)", precision: 18, scale: 4, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Type = table.Column<string>(type: "text", nullable: false, defaultValue: "Debit"),
                    CategoryId = table.Column<int>(type: "integer", nullable: false),
                    AccountSourceId = table.Column<int>(type: "integer", nullable: false),
                    TransferToAccountSourceId = table.Column<int>(type: "integer", nullable: true),
                    UserId = table.Column<string>(type: "text", nullable: true)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Transactions_AccountSources_AccountSourceId",
                        column: x => x.AccountSourceId,
                        principalTable: "AccountSources",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Transactions_AccountSources_TransferToAccountSourceId",
                        column: x => x.TransferToAccountSourceId,
                        principalTable: "AccountSources",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Transactions_TransferToAccountSourceId",
                table: "Transactions",
                column: "TransferToAccountSourceId");
